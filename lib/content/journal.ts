...
export const journal: JournalEntry[] = [
  ...
  /* --------------------------------------------------- it begins again ---- */
  {
    ...
    mature: false,
    body: [
      "I should write down what it is, because if anyone ever reads this book they will need it explained, and because I think it stopped being a joke this week.",
