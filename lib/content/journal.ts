...
export const journal: JournalEntry[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "He knows. I think he knows. He came by at six with groceries I hadn't asked for and stood in this kitchen a beat too long, and then we played the staring game.",
      "Twenty years — I know exactly what that is. He was after something. He wanted me to fill the silence and hand it to him, and I stood there holding a bag of shopping and did not.",
      "He can break first.",
      "Got in the shower afterwards and sat with the fact that I have just used our own thing against him.",
      "Anyway. I'm late.",
    ],
  },
  {
  ...
  /* --------------------------------------------------- it begins again ---- */
  {
    ...
    body: [
      ...
      "He did it to me on Tuesday. Properly. Came up for the gate, and somewhere between the truck and the barn he stopped talking, and then he was just there — close enough that I could see him deciding not to say it — and he waited.",
      "And I didn't crack.",
      "Twenty years. It has never once failed, on either of us, and I stood in my own yard and held it, and he saw me hold it, and that told him more than anything I could have confessed.",
  ...
  },
  {
    ...
    body: [
      ...
      "I know his silences. I have twenty years of them catalogued — the one when he's angry, the one when he's working something out, the one he uses to make you crack. This was a new one. This was a man holding a thing down with both hands and letting me see the effort.",
