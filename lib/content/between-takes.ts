...
export const notes: SetNote[] = [
  ...
  },
  {
    ...
    author: "rick",
    kind: "insight",
    heading: "The one time I say her name",
    dateline: "Day 20 · the lake",
    sceneSlug: "josh-rick-lake",
    place: "lake",
    access: "premium",
    body: [
      "Josh drives all the way out here with the worst thing that has ever happened to him, and the note Melissa gave me was about where I am looking. I keep my eyes on the water for nearly all of it. That is not me being cruel to him. It is the only way I have ever known how to sit next to my son.",
      "The advice itself is good. He asks how he fixes this and I tell him he does not — he fixes himself. Out of almost anybody else's mouth that is the kindest thing said to him in the whole film. We tried it warmer twice and it was worse both times, because warm made it usable, and the entire trouble with me is that nothing I give him ever arrives in a form he can use.",
      "I say Luna's name once. I did not notice until we were shooting that it is not even my sentence — it is inside a thing her mother said to me, so I am quoting somebody else to get it out. In the study I never manage it at all.",
      "And I already know where she is staying before he tells me, because I had talked to her mother days earlier. I would like it written down that I was not saving that up to win with. I wanted to hear she was all right. Then I sat on it and let him drive out here for it, which is the same thing I have been doing to him his whole life.",
    ],
  },
